...
class CustomUser(AbstractUser):
    ...
    AO_order_list = models.ManyToManyField(
        Order, blank=True, related_name="AO_order_list")
    ...
    def update_status(self):
        ...
        orders = self.order.filter(
            is_cancelled=False, date__lte=date, date__gte=date_min)
        if orders:
            member = False
